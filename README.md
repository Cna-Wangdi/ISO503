...
ISY503_NLP/
│
├── sentiment_pipeline.py        # Main training script
├── app.py                       # Streamlit web interface
├── sentiment_lstm_model.keras   # Trained Bidirectional LSTM model
├── tokenizer.pickle             # Tokenizer used during training
├── domain_sentiment_data/       # Dataset folder (not included in repo if large)
└── README.md                    
...
domain_sentiment_data/sorted_data_acl/
    ├── books/
    ├── dvd/
    ├── electronics/
